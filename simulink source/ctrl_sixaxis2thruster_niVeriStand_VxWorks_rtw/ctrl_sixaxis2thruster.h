...
typedef struct {
  ...
  real_T Scope1_DWORK1;                /* '<Root>/Scope1' */
  real_T R2_continuous_DWORK1;         /* '<Root>/R2_continuous' */
  real_T Scope2_DWORK1;                /* '<Root>/Scope2' */
  ...
  uint8_T Scope1_DWORK2[22];           /* '<Root>/Scope1' */
  uint8_T R2_continuous_DWORK2[22];    /* '<Root>/R2_continuous' */
  uint8_T Scope2_DWORK2[22];           /* '<Root>/Scope2' */
...
struct P_ctrl_sixaxis2thruster_T_ {
  ...
  real_T L2_continuous_P6;             /* Expression: btype
                                        * Referenced by: '<Root>/L2_continuous'
                                        */
  real_T Scope1_P1;                    /* Expression: width
                                        * Referenced by: '<Root>/Scope1'
                                        */
  real_T Scope1_P2;                    /* Expression: dtype
                                        * Referenced by: '<Root>/Scope1'
                                        */
  real_T Scope1_P3;                    /* Expression: portnum
                                        * Referenced by: '<Root>/Scope1'
                                        */
  real_T Scope1_P4;                    /* Expression: stime
                                        * Referenced by: '<Root>/Scope1'
                                        */
  real_T Scope1_P5;                    /* Expression: stype
                                        * Referenced by: '<Root>/Scope1'
                                        */
  real_T Scope1_P6;                    /* Expression: btype
                                        * Referenced by: '<Root>/Scope1'
                                        */
  ...
  real_T R2_continuous_P6;             /* Expression: btype
                                        * Referenced by: '<Root>/R2_continuous'
                                        */
  real_T Scope2_P1;                    /* Expression: width
                                        * Referenced by: '<Root>/Scope2'
                                        */
  real_T Scope2_P2;                    /* Expression: dtype
                                        * Referenced by: '<Root>/Scope2'
                                        */
  real_T Scope2_P3;                    /* Expression: portnum
                                        * Referenced by: '<Root>/Scope2'
                                        */
  real_T Scope2_P4;                    /* Expression: stime
                                        * Referenced by: '<Root>/Scope2'
                                        */
  real_T Scope2_P5;                    /* Expression: stype
                                        * Referenced by: '<Root>/Scope2'
                                        */
  real_T Scope2_P6;                    /* Expression: btype
                                        * Referenced by: '<Root>/Scope2'
                                        */
